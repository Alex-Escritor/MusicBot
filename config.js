...
module.exports = {
    ...
    riffyNodes: [
        {
            name: "Lanya Audio", // The name of the node
            host: "lavalink.jirayu.net", // The hostname of the lavalink server
            port: 13592,  // The port of the lavalink server
            password: "youshallnotpass", // The password of lavalink server
